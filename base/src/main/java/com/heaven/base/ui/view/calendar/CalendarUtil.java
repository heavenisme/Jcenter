...
public final class CalendarUtil {
    ...
    @SuppressLint("SimpleDateFormat")
    public static String getDateFormat(String formatStr, Date date) {
        SimpleDateFormat format = new SimpleDateFormat(formatStr);
     ...
     * @return 日期
     */
   public static Calendar getNextSomeDayCalendar(Calendar calendar,int days) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        date.setTimeInMillis(timeMills + ONE_DAY * days);
